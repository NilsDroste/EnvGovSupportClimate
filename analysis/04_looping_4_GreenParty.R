...
### model
lm4_didit_greens <- lm(
  MiljöpartietMP ~ #PolicyIndicator*Date_numeric +
...
timeseriesplot4_greens <- preds4_greens  %>% #filter(!is.na(PolicyIndicator)) %>%
...
plot4_greens <- cowplot::plot_grid(
  timeseriesplot4_greens,
  # cowplot::plot_grid(plotlist =plot_lst4_greens_controls,nrow = 1),
  cowplot::plot_grid(
...
# lapply(lin_regs_lst4_greens, summary)
# lapply(lin_regs_lst4_greens_controls, summary)
# lapply(lin_regs_lst4_greens_resids, summary)
=======
library(tidyverse)
library(here)
library(sandwich)
